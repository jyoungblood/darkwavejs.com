...
dw field guide htmx
- cool to have examples of "stupid htmx tricks" - cool and fun but PRACTICAL copy/paste code examples of htmx-based interactivity
- rationale why htmx is a great fit w/ astro (& vice versa) - https://jhuleatt.com/posts/astro-htmx
