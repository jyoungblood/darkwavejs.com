...
it's also: conventions (vs config) - Sets conventions/standards (we use kysely, mysql, tailwind, etc)
Like You’re not gonna use something else if you’re using dw (you're not gonna use prisma or drizzle...fuck off)
