...
In practice it’s just an Astro theme & boilerplate, but in (theory/reality) it’s so much more. it's a very efficient workflow and conceptual (guideline, mental framework)
