...
need: primer on RBAC rules creation
creating auth config (simple vs complex)
users updating their own content is fine/easy, but anything involving pivot tables (ex users on teams or in orgs only updating certain content) is a little more involved, and you have to write some rules...not a big deal to figure out, but it's imperative
